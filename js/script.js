...
const materiDatabase = {
    1: {
        ...
        fullText: `<h3>World Wide Web</h3><p>WWW adalah kumpulan web diseluruh dunia yang memberikan layanan informasi melalui halaman web [cite: 1].</p><h3>Client-Server</h3><p>Server menyimpan data, sementara Client (browser) meminta dokumen tersebut[cite: 1].</p>`,
        youtubeUrl: "https://www.youtube.com/watch?v=UB1O30fR-EE",
        pdfUrl: "assets/pdf/TPL0293_01_PENGENALAN WEB.pdf"
    },
    2: {
        title: "Basic Tag HTML",
        fullText: `<h3>Struktur Dasar</h3><p>HTML menggunakan tag berpasangan &lt;..&gt; dan diakhiri &lt;/..&gt; [cite: 2].</p><h3>Format Dokumen</h3><p>Penggunaan Heading (h1-h6), Paragraf (p), dan tag dasar lainnya[cite: 2].</p>`,
    ...
    3: {
        ...
        fullText: `<h3>Formatting</h3><p>Penggunaan tag b, i, u, strong, em, small, big, serta subscript (sub) dan superscript (sup) [cite: 3].</p><h3>Karakter Khusus</h3><p>Penggunaan simbol khusus yang didefinisikan dalam modul[cite: 3].</p>`,
    ...
    4: {
        ...
        fullText: `<h3>Multimedia</h3><p>Menampilkan gambar dengan tag img, peta gambar (map), serta video HTML5 menggunakan tag video[cite: 4].</p>`,
        youtubeUrl: "https://www.youtube.com/watch?v=L9p99vE6-Rk",
        pdfUrl: "assets/pdf/TPL0293_04_MENAMPILKAN GAMBAR, SUARA DAN VIDEO.pdf"
    },
    5: {
        title: "Hyperlink",
        fullText: `<h3>Jenis Link</h3><p>Terdiri dari Link Relative, Link Absolute, Link Anchor (halaman sama), dan Link Email[cite: 5].</p>`,
    ...
    6: {
        ...
        fullText: `<h3>List HTML</h3><p>Ordered List (ol) untuk penomoran, Unordered List (ul) untuk simbol bullet, dan Definition List (dl)[cite: 6].</p>`,
        youtubeUrl: "https://www.youtube.com/watch?v=0pLidLIDv9Y",
        pdfUrl: "assets/pdf/TPL0293_06_BULLET NUMBERING DAN LIST.pdf"
    },
    7: {
        title: "Tabel",
        fullText: `<h3>Struktur Tabel</h3><p>Membuat tabel menggunakan tag table, tr, th, dan td serta atribut colspan dan rowspan[cite: 7].</p>`,
        youtubeUrl: "https://www.youtube.com/watch?v=Yp69GclY3YI",
        pdfUrl: "assets/pdf/TPL0293_07_TABEL.pdf"
    },
    8: {
        title: "Formulir (FORM)",
        fullText: `<h3>Elemen Form</h3><p>Mendapatkan umpan balik atau biodata melalui input text, radio button, checkbox, dan select[cite: 8].</p>`,
        youtubeUrl: "https://www.youtube.com/watch?v=680XjU5YvIs",
        pdfUrl: "assets/pdf/TPL0293_08_FORM.pdf"
    },
    9: {
        title: "Frame",
        fullText: `<h3>Frameset</h3><p>Mengatur tata letak layar menjadi beberapa bagian menggunakan baris (rows) dan kolom (cols)[cite: 9].</p>`,
        youtubeUrl: "https://www.youtube.com/watch?v=w9yY1Y1YF00",
        pdfUrl: "assets/pdf/TPL0293_09_FRAME.pdf"
    },
    10: {
        title: "IFRAME",
        fullText: `<h3>Inline Frames</h3><p>Berfungsi untuk meng-embed dokumen lain atau konten dari web lain ke dalam halaman aktif[cite: 10].</p>`,
    ...
    11: {
        ...
        fullText: `<h3>Struktur CSS</h3><p>Terdiri dari selector, property, dan value untuk mengatur tampilan web secara konsisten[cite: 11].</p>`,
    ...
    12: {
        ...
        fullText: `<h3>Atribut Class</h3><p>Memungkinkan variasi bermacam-macam style dari suatu elemen dengan penamaan sendiri[cite: 12].</p>`,
        youtubeUrl: "https://www.youtube.com/watch?v=nPhVp7UfSfc",
        pdfUrl: "assets/pdf/TPL0293_12_CLAS DALAM CASCADING STYLE SHEET.pdf"
    },
    13: {
        title: "Division (DIV)",
        fullText: `<h3>Tag DIV</h3><p>Digunakan untuk mengelompokkan elemen HTML menjadi bagian Header, Footer, Content, dan Sidebar[cite: 13].</p>`,
        youtubeUrl: "https://www.youtube.com/watch?v=mD07vN-mN2A",
        pdfUrl: "assets/pdf/TPL0293_13_DIVISION (DIV).pdf"
    },
    14: {
        title: "Pengenalan JavaScript",
        fullText: `<h3>Client-Side Scripting</h3><p>Instruksi yang diproses langsung oleh browser untuk interaktivitas dokumen HTML[cite: 14].</p>`,
        youtubeUrl: "https://www.youtube.com/watch?v=RUTV_5m4VeI",
        pdfUrl: "assets/pdf/TPL0293_14_PENGENALAN JAVA SCRIPT.pdf"
    },
    15: {
        title: "Dialog Box",
        fullText: `<h3>Popup Box</h3><p>Penggunaan Alert, Prompt, dan Confirm untuk berinteraksi dengan pengguna[cite: 15].</p>`,
    ...
    16: {
        ...
        fullText: `<h3>Tipe Data Implisit</h3><p>Mengenal tipe Numerik, String, Boolean, dan Null serta operator aritmatika[cite: 16].</p>`,
    ...
    17: {
        ...
        fullText: `<h3>Control Flow</h3><p>Penggunaan perintah IF untuk percabangan dan perulangan menggunakan For, While, atau Do-While[cite: 17].</p>`,
    ...
    18: {
        ...
        fullText: `<h3>Koleksi Data</h3><p>Menggunakan Function untuk instruksi berulang dan Array untuk menampung banyak nilai[cite: 18].</p>`,
